...
<div className=" top-[0px]  w-full h-[300px] xl:h-[620px] lg:h-[500px] mx-0 lg:mx-[30px]">
  ...
  />
  <div
    className="absolute top-[200.89px] md:right-5 right-[98px] md:w-[183.27px] h-[115.38px] w-auto scale-50 md:scale-100 [transform-origin:0_0]"
  ><img
    ...
    /></div><img
    className=" absolute w-[183.9px] h-[252.28px] mt-[70px] md:mt-0 lg:w-[366.9px] lg:h-[494.28px] left-0"
    
    src="/group-7.svg"
  /><div
    className="absolute top-[250.7px] scale-50 md:scale-100 [transform-origin:0_0]"
  ><img

...
const NewsDrop = () => {
    ...
    return (
        <div>
        <div className="flex flex-col items-center justify-start gap-[28px] w-full mt-[40px] lg:mt-[68px]  ">
            <div className="self-stretch flex flex-row items-start justify-start">
                <div className="flex-1 flex flex-row items-start justify-start">
                    ...
                    <div className="rounded-131xl bg-white hidden md:flex flex-row py-5 px-[30px] items-center justify-center gap-[4px]">
            ...
            <div className="w-full h-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 flex-row items-start justify-start gap-[20px] text-left">
                {featuresData.map((item,index) => (
                    ...
                    <div key={item.id} className={`relative rounded-31xl bg-white overflow-hidden h-auto
                    ${
                       ...
                       <div className="flex flex-col items-start justify-start gap-[16px]">
                            ...
                            <div className="rounded-131xl bg-primary w-[124px] flex flex-row py-7 px-10 box-border items-center justify-center "
  ...
  {/*
        <div>
            <div className="flex flex-col items-center justify-start gap-[28px] w-full mt-[40px] lg:mt-[68px]  ">
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 flex-row items-start justify-start gap-[20px] text-left">
                    {featuresData.map((item,index) => (

                        <div key={item.id} className={`relative rounded-31xl bg-white xl:h-[612px] h-[440px] overflow-hidden
                        ${
                            (index >= currentSlide && index < currentSlide + visibleSlidesCount) ? 'block' : 'hidden'
                          }`}>
                            {card === item.id ? (
                               <div className="w-full h-full bg-white rounded-tl-2xl rounded-tr-2xl rounded-bl-3xl rounded-br-3xl">
                               <div className="mb-5 w-full py-5 absolute bottom-0 bg-primary rounded-full justify-center items-center inline-flex">
                                 <div className=" grow shrink basis-0 text-center text-stone-950 text-base font-normal uppercase leading-normal">Add to cart</div>
                               </div>
                               <div className="mt-10 px-5 flex justify-start items-start gap-4">
                                 <div className="grow shrink basis-0 text-stone-950 text-xl font-normal uppercase leading-normal">pepka Cap</div>
                                 <div className="text-center text-stone-950 text-2xl font-normal uppercase leading-7">$28</div>
                            ...
                            (
                                <>
                            <div className="absolute xl:top-[512px] top-[352px] left-[36px] flex flex-row items-start justify-start gap-[0] lg:gap-0 xl:gap-[150px] md:gap-[57px]">
                                <div className="flex flex-col items-start justify-start gap-[16px]">
                                ...
                                <img
                                className="absolute w-full top-[0px] right-[0px] left-[0px] max-w-full overflow-hidden object-cover"
                                alt=""
                                src="/image@2x.png"
                            />
                            <div className="w-1/6 rounded-21xl bg-overlay [backdrop-filter:blur(40px)] flex flex-row py-2.5 px-5 m-5 items-center justify-center text-center text-mini">
                                <div className=" leading-[20px] uppercase">20/50</div>
                            </div>
                                </>
                            )}
